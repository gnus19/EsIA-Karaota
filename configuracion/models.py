...
class Estudio(models.Model):
	...
	intensidad =models.ForeignKey(Intensidad, default='', on_delete=models.PROTECT)
	extension = models.ForeignKey(Extension, default='', on_delete=models.PROTECT)
	duracion =models.ForeignKey(Duracion, default='', on_delete=models.PROTECT) 
	reversibilidad = models.ForeignKey(Reversibilidad, default='', on_delete=models.PROTECT)
	probabilidad = models.ForeignKey(Probabilidad, default='', on_delete=models.PROTECT)
