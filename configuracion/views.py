...
class EstudioCreate(CreateView, SuccessMessageMixin):
	...
	def form_valid(self, form):
		...
		for i in consulta_intensidad:
			if dict(VALOR_SA).get(i.valor_sociocultural) == valor_sa and dict(GRADO_PERTUBACION).get(i.grado_perturbacion)== grado_perturbacion:
...
# Calculo del VIA
def _calcular_via(estudio, valor_intensidad, valor_duracion, valor_reversibilidad, valor_extension, valor_probabilidad):
